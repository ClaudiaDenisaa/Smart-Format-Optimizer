...
static void write_stats_file(int client_id,
    ...
    fprintf(f, "last_filesize_initial=%d\n", initial_size);
    fprintf(f, "last_filesize_final=%d\n", final_size);
                        ...
                        if (clientID == 0) {
                            ...
                            case OPR_OPTIMIZE:
                            {
...

                                {
                                    ...
                                    if (type == 1) {
                                        fprintf(stderr, "JPEG received\n");
                                    } else {
                                        fprintf(stderr, "PNG received\n");
                                    }
                                }

                                writeBinary(i, h, img.data, img.size);
                                free(img.data);
                            }
                            break;
