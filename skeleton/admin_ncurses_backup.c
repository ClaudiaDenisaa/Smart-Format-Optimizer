...
typedef struct admin_stats {
    ...
    char last_filesize_initial[64];
    char last_filesize_final[64];
...
static void set_default_stats(admin_stats_t* stats) {
    ...
    strcpy(stats->last_filesize_initial, "N/A");
    strcpy(stats->last_filesize_final, "N/A");
...
static int load_stats(admin_stats_t* stats) {
    ...
    while (fgets(line, sizeof(line), f) != NULL) {
        ...
        parse_stat_line(line, "last_filesize_initial=", stats->last_filesize_initial, sizeof(stats->last_filesize_initial));
        parse_stat_line(line, "last_filesize_final=", stats->last_filesize_final, sizeof(stats->last_filesize_final));
...
static void draw_ui(const admin_stats_t* stats) {
    ...
    mvprintw(7, 4, "Initial filesize : %s", stats->last_filesize_initial);
    mvprintw(8, 4, "Final filesize   : %s", stats->last_filesize_final);
    mvprintw(9, 4, "Last client id   : %s", stats->last_client_id);
    mvprintw(10, 4, "Last status      : %s", stats->last_status);
    mvprintw(11, 4, "Last refresh     : %s", stats->last_refresh_time);
    mvprintw(12, 4, "Stats file       : %s", stats->stats_file_status);

    mvprintw(14, 2, "======================================");
    mvprintw(15, 2, "Auto refresh every 2 seconds");
